...
@section('content')
        ...
        <div class="card m-b-20">
            <div class="card-body">
                ...
                <div class="d-flex mb-2">
                    <h4 class="mt-0 header-title m{{getInvDir()}}-auto">  @lang('admin.numberOfRooms')  </h4>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="javascript:void(0);" data-route="{{route('get.numberOfRooms.delete',[$row->id])}}" class="text-muted  delete-row " data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="mdi mdi-close font-18"></i></a>
                                </td>
                            </tr>
                            @endforeach
    ...
    @include('numberOfRooms.forms.add')
    @include('numberOfRooms.forms.edit')

@endsection

<?php $routeAdd = route('post.numberOfRooms.store'); ?>
<?php $routeEdit = route('put.numberOfRooms.update'); ?>
@section('script')
